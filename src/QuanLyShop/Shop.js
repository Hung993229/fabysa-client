            ...
            {ttShop && ttShop.length !== 0 && (
                <div className="shop">
                    ...
                    <div className="sanPham-shop">
                        {/* ssp dan */}
                        {allSanPhamDan && allSanPhamDan.length !== 0 && (
